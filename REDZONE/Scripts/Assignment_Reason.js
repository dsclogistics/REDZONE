...
function saveReasons(startAP) {
    ...
    if (reasonsToDelete_List == "" && reasonsToUpdate_List == "" && reasonsToAdd_List == "") {
        ...
        if (startAP) {  //Just redirect to Action Plans Page
        ...
        else { showAlert("There are no changes to Save"); }        
    }
    else {
        ...
        $.ajax({
            ...
            //Once Saving procedure has completed, do required action if AP needs to be started or not
            if (startAP) {// Action Plan needs to be Started. Redirect User to the AP page to start it.
                //alert("/ActionPlan/viewEdit/?" + "mp_id=" + getMPid() + "&bldg_id=" + getBuildingId() + "&bapm_id=" + localStorage.getItem("bapmId"));
                ...
                $("#msgFormBodyData").html('<span style="font-weight:bold; color:green">Reasons Saved Successfully</span><br /><br />' );
...
$(document).ready(function () {
    ...
    $('#mReason').show();                          // Show a new Menu Item when this page is displayed
    $("#mReason").addClass("menuSelected");
    ...
    $('#btnSaveProg').click(function () {
        ...
        if ($('#hdnMpvId').val() == null || $('#hdnMpvId').val() == 0) {
            ...
            saveReasons(false);           // Do Saving procedure (Param "false" = Do not Start the Action Plan)
        }
    ...
    $('#btnBeginAction').click(function () {
        saveReasons(true);           // Do Saving procedure (Param "true" = Start the Action Plan after Saving)
    });
    // ------------------------------------------------------------------------------------------------------
